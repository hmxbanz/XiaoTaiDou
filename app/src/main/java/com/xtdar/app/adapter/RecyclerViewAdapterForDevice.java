...
import com.xtdar.app.model.Device;
...
public class RecyclerViewAdapterForDevice extends RecyclerView.Adapter<RecyclerViewAdapterForDevice.DataHolder>  {
...
public RecyclerViewAdapterForDevice(List<Device> l, Context c){
    this.listItems=l;
    this.context=c;
    ...
    public void onBindViewHolder(DataHolder holder, final int position) {
        ...
        final Device listItem = listItems.get(position);
