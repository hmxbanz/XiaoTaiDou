 ...
 * Company RongCloud
 */
public class ShopBoyFragment extends Fragment implements RecyclerViewAdapterForShopProduct.ItemClickListener {
    public static ShopBoyFragment instance = null;
    ...
    public static ShopBoyFragment getInstance() {
        if (instance == null) {
            instance = new ShopBoyFragment();
        }
        return instance;
    }
