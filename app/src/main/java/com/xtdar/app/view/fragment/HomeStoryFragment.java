 ...
 * Company RongCloud
 */
public class HomeStoryFragment extends Fragment implements RecyclerViewAdapter.ItemClickListener {
    public static HomeStoryFragment instance = null;
    ...
    public static HomeStoryFragment getInstance() {
        if (instance == null) {
            instance = new HomeStoryFragment();
        }
        return instance;
    }
