 ...
 * Company RongCloud
 */
public class ShopGirlFragment extends Fragment implements RecyclerViewAdapterForShopProduct.ItemClickListener {
    public static ShopGirlFragment instance = null;
    ...
    public static ShopGirlFragment getInstance() {
        if (instance == null) {
            instance = new ShopGirlFragment();
        }
        return instance;
    }
