 ...
 * Company RongCloud
 */
public class HomeCountryFragment extends Fragment implements RecyclerViewAdapter.ItemClickListener {
    public static HomeCountryFragment instance = null;
    ...
    public static HomeCountryFragment getInstance() {
        if (instance == null) {
            instance = new HomeCountryFragment();
        }
        return instance;
    }
