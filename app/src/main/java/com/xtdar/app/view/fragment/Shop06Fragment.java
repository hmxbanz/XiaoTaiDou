 ...
 * Company RongCloud
 */
public class Shop06Fragment extends Fragment implements RecyclerViewAdapterForShopProduct.ItemClickListener {
    public static Shop06Fragment instance = null;
    ...
    public static Shop06Fragment getInstance() {
        if (instance == null) {
            instance = new Shop06Fragment();
        }
        return instance;
    }
